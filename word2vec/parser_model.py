...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        a, b = w.view(-1), w.size(0)
        x = self.embeddings[a].view(b, -1)
    ...
    def forward(self, w):
        ...
        hidden_layer = self.dropout(F.relu(torch.matmul(embeddings, self.embed_to_hidden_weight)) + self.embed_to_hidden_bias)
